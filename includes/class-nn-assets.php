...
class NN_Assets {
	...
	public function register_shared() {
		...
		wp_register_style(
			'nn-shortcodes-hero-home',
			NN_SHORTCODES_URL . 'assets/css/nn-shortcodes-hero-home.css',
			array( 'nn-shortcodes' ),
			NN_SHORTCODES_VERSION
		);
		...
		wp_register_style(
			'nn-shortcodes-hero-google-ads',
			NN_SHORTCODES_URL . 'assets/css/nn-shortcodes-hero-google-ads.css',
			array( 'nn-shortcodes' ),
			NN_SHORTCODES_VERSION
		);
		...
		wp_register_script(
			'nn-shortcodes-hero-home',
			NN_SHORTCODES_URL . 'assets/js/nn-shortcodes-hero-home.js',
			array(),
			NN_SHORTCODES_VERSION,
			true
		);
